import {
  ...
  HttpHeaders,
  HttpParams
} from "./chunk-F4XCGZ43.js";
import {
  CommonModule,
  DOCUMENT
} from "./chunk-H5YR3GBH.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
_MemoryStorage.ɵfac = function MemoryStorage_Factory(t) {
  return new (t || _MemoryStorage)();
};
...
_UrlHelperService.ɵfac = function UrlHelperService_Factory(t) {
  return new (t || _UrlHelperService)();
};
...
_DefaultHashHandler.ɵfac = function DefaultHashHandler_Factory(t) {
  return new (t || _DefaultHashHandler)();
};
...
_OAuthService.ɵfac = function OAuthService_Factory(t) {
  return new (t || _OAuthService)(ɵɵinject(NgZone), ɵɵinject(HttpClient), ɵɵinject(OAuthStorage, 8), ɵɵinject(ValidationHandler, 8), ɵɵinject(AuthConfig, 8), ɵɵinject(UrlHelperService), ɵɵinject(OAuthLogger), ɵɵinject(HashHandler, 8), ɵɵinject(DOCUMENT), ɵɵinject(DateTimeProvider));
};
...
_DefaultOAuthInterceptor.ɵfac = function DefaultOAuthInterceptor_Factory(t) {
  return new (t || _DefaultOAuthInterceptor)(ɵɵinject(OAuthService), ɵɵinject(OAuthResourceServerErrorHandler), ɵɵinject(OAuthModuleConfig, 8));
};
...
_OAuthModule.ɵfac = function OAuthModule_Factory(t) {
  return new (t || _OAuthModule)();
};
